...
pander(table(quiz1028.div$college, quiz1028.div$Q1))
pander(table(quiz1028.div$college, quiz1028.div$Q2))
pander(table(quiz1028.div$college, quiz1028.div$Q3))
pander(table(quiz1028.div$college, quiz1028.div$Q4))
pander(mapply(function(x) xtabs(~college + x, data=quiz1028.div), quiz1028.div[c("Q1", "Q2", "Q3", "Q4")]))
q.ans.tbl <- apply(q.ans, 2, table, useNA="ifany")
pander(q.ans.tbl)
pander(table(q.ans.max.tax.rate))
pander(table(q.ans.book.of.change))
